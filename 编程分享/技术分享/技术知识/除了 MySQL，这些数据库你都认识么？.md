...
但是，如果你搜索 “千羽程序员”，是无法得到搜索结果的，因为没有任何一个文档的内容，完全包含 “千羽程序员” 这个词（文档内容 2 只有 “千羽”、“程序员” 这两个词）。
...
有了上述的倒排索引，当用户搜索 “千羽程序员” 时，搜索引擎数据库会先对搜索词进行分词，得到 “千羽” 和 “程序员”，然后根据这两个词汇就能找到文档 id 1、2 了。不用再去遍历表内所有的数据，实现了更灵活、快速的 **模糊搜索** 。
...
拿千羽公司每天的收入来举个例子，传统的行式（关系型）数据库是这么存储的：
