...
> 不知道怎么生成前端代码的同学，可以去补下 [千羽的项目教程](https://mp.weixin.qq.com/s/a5X7bNI_ydVuu7NV1eQhZQ) 。
...
千羽原创的定制化代码生成项目中，演示了如何使用对象存储实现代码生成器文件的上传和下载。

感兴趣的同学欢迎加入 [编程导航](https://mp.weixin.qq.com/s/a5X7bNI_ydVuu7NV1eQhZQ) ，跟着千羽一起学编程、做项目~